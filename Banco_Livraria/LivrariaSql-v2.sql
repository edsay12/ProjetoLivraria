...
-- Copiando dados para a tabela livrariadb.clientes: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `clientes` DISABLE KEYS */;
INSERT INTO `clientes` (`idCliente`, `cpfCliente`, `nomeCliente`, `numeroCliente`, `ruaCliente`, `cidadeCliente`, `bairroCliente`) VALUES
...
INSERT INTO `livros` (`idLivro`, `nomeLivro`, `tipoLivro`, `valorLivro`, `quantidadeLivro`) VALUES
	(1, 'Castelo Azul', 'Historia', 50.00, 2),
	(2, 'harry Potter', 'Conto', 100.00, 6);
...
-- Copiando dados para a tabela livrariadb.vendas: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela livrariadb.vendedor: ~2 rows (aproximadamente)
