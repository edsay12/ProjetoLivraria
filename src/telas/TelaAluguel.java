...
public class TelaAluguel extends javax.swing.JFrame {
    ...
    public void ComboConsult() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Combo.addItem(rs.getString(3) +','+rs.getString(2));
    ...
    private void initComponents() {
        ...
        txtCliente.setBackground(new java.awt.Color(0, 204, 204));
    ...
    private void ComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComboActionPerformed
        int id = Combo.getSelectedIndex()-1;
        txtCliente.setText(id_cliente.get(id).toString());
